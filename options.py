...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--isize', type=int, default=32, choices=[32, 64, 128, 256, 512], help='input image size.')
        ...
        self.parser.add_argument('--model', type=str, default='skipganomaly', choices = ['skipganomaly', 'skipganomaly_pp', 'ensemble'], help='chooses which model to use. ganomaly')
        self.parser.add_argument('--ensemble_init', type=str, default='scratch', choices=['scratch', 'pretrained'])
        self.parser.add_argument('--pretrained_skip_ckpt', type=str, default='')
        self.parser.add_argument('--pretrained_pp_ckpt', type=str, default='')
        ...
        self.parser.add_argument('--use_multiscale', action='store_true')
